...
import 'package:flutter_blue_plus_example/printer_service.dart';
...
class _DeviceScreenState extends State<DeviceScreen> {
  ...
  void _printLabel() async {
    await printerService.printLabel(widget.device.platformName);
  }
  ...
  //   final Generator textGenerator = Generator(PaperSize.mm58, profile);
  ...
  //     // Generate or process text using eos_pos_utils
  //     String testText = "Test Print\nThis is a test print from Zenpert 3R20P.";
  //     String formattedText = testText;

  //     // Write to the characteristic
  //     await targetCharacteristic.write(utf8.encode(formattedText));
  //   }
            ...
            children: <Widget>[
              ...
              ElevatedButton(
                  onPressed: () async {
                    _printLabel;
                    // final profile =
                    //     await CapabilityProfile.getAvailableProfiles();
                    // final generator = Generator(PaperSize.mm58, profile[0]);
                    // generator.beep(n: 5); // Example usage
                  ...
                  child: const Text("Try print label")),
